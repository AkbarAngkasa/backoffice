            ...
            <aside id="default-sidebar" className="flex flex-row fixed top-0 left-0 z-40 w-full h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidenav">
                ...
                <div className="overflow-y-auto py-5 px-3 w-[70%] sm:w-[20%] h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    <ul className="space-y-2">
                        ...
                        <li>
                            <Link to="/dashboard" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group" data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar">
                        ...
                        <li>
                            <button type="button" className="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-configuration" data-collapse-toggle="dropdown-configuration">
                                ...
                                <span className="flex-1 ml-3 text-left whitespace-nowrap" >Configuration</span>
                            ...
                            <ul id="dropdown-configuration" className="hidden py-2 space-y-2">
                                <li>
                                    <Link to="/dashboard/configuration/fee-management" className="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar">Fee management</Link>
                                </li>
                            </ul>
                        </li>
                    </ul>
